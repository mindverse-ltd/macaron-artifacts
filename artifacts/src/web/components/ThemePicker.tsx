...
function ThemeSample({ id, slot }: { id: ThemeId; slot: ThemeSlot }) {
  ...
  return <>
    <div aria-hidden="true" data-sample={slot} data-palette={sample.id} data-theme={slot} style={{ ...sample.style, colorScheme: slot }} className="theme-sample flex h-28 flex-col justify-between overflow-hidden rounded-lg border border-control-border bg-surface p-3 text-fg">
