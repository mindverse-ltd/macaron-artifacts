...
export function Composer({ disabled, busy, onSend, onStop }: { disabled: boolean; busy: boolean; onSend: (text: string) => void; onStop: () => void }) {
  ...
  return <div className="shrink-0 border-t border-border p-3"><div className="interactive mx-auto flex w-full max-w-3xl items-end gap-2 rounded-2xl border border-input-border bg-input-bg p-2 focus-within:border-focus">
