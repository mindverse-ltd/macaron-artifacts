...
async function existingPrUrl(cwd, branch) {
    try {
...
export async function getPrContext(cwd) {
    ...
    const existing = branch !== defaultBranch && branch !== 'HEAD' ? await existingPrUrl(cwd, branch) : undefined;
...
export async function createPr(cwd, input) {
