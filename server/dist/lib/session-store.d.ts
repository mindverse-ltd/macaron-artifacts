import type { MessageSearchHit, SessionDetail, SessionListItem, Workspace } from '@macaron/shared';
...
export declare function searchMessages(query: string, limit?: number): Promise<MessageSearchHit[]>;
export {};
