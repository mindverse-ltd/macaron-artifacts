import { deleteSession, duplicateSession, readSessionMessages, resolveProjectCwd, resolveSessionCwd, rewindSession, writeCompactedSession, } from '../lib/session-store.js';
...
export async function registerSessionRoutes(app) {
    ...
    app.get('/api/sessions/claude/:project/commands', async ({ params }) => {
