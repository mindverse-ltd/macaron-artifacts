    ...
    <HomeLayout {...baseOptions()}>
      <div className="site:flex site:flex-col site:items-center site:flex-1 site:px-4">
        <section className="site:flex site:flex-col site:items-center site:text-center site:max-w-2xl site:pt-20 site:pb-16">
          <span className="site:inline-flex site:items-center site:gap-1.5 site:rounded-full site:border site:px-3 site:py-1 site:text-xs site:text-fd-muted-foreground site:mb-6"><Terminal className="site:size-3.5" /> Claude Code &amp; Codex</span>
          <h1 className="site:text-4xl site:sm:text-5xl site:font-bold site:mb-4">Macaron Artifacts</h1>
          <p className="site:text-fd-muted-foreground site:text-lg site:mb-8">One local WebUI for your coding harnesses. Stream conversations and interactive UI, then pick Claude Code or Codex for the next session.</p>
        ...
        <section className="site:w-full site:max-w-3xl site:pb-20">
          ...
          <p className="site:mt-3 site:text-sm site:text-fd-muted-foreground">Requires Node.js 22 or newer and an installed, authenticated Claude Code or Codex CLI. The preview package is pinned to this build's commit.</p>
