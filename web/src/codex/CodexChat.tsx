  ...
  return (
    <div className="cx-genui">
      <Suspense fallback={<div className="cx-genui-loading">Loading GenUI runtime…</div>}>
        <GenuiPreview code={it.code} done={!it.streaming} engine="codex" widgetId={it.id} />
      </Suspense>
...
export function CodexChat(props: CodexChatProps = {}) {
  ...
  // Latest `sending` for the loop subscription and countdown bridge's stable
  // callbacks. A manual turn owns the live timeline while it is true.
