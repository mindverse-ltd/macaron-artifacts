...
type Item =
  ...
  | { id: string; kind: 'tool'; name: string; input: unknown; result?: string; isError?: boolean; diagnostics?: Diagnostic[] }
  ...
  switch (it.kind) {
    ...
    case 'tool': {
      ...
      return diff
        ...
        : <ToolItem name={it.name} input={it.input} result={it.result} diagnostics={it.diagnostics} />;
    }
    case 'todo':
